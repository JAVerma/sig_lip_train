...
class multiclassdataset(Dataset):
    def __init__(self, hfdataset, image_processor):
    ...
    def __getitem__(self, idx):
        ...
        inputs=self.processor(text=[self.texts[idx]], images=self.images[idx].convert("RGB"), padding="max_length", return_tensors="pt")
