...
from ..clip.modeling_clip import CLIPOutput, CLIPVisionConfig, CLIPVisionModel, CLIPTextModel, CLIPTextConfig
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        if text_model is None:
            ...
            if "clip" in text_model_name_or_path:
        ...
        if "clip" in text_model_name_or_path:
            config = VisionTextDualEncoderConfig.from_vision_text_configs(vision_model.config, text_config, **kwargs)
        else:
