...
def main(args):
    ...
    log_base_path = os.path.join(args.logsdir, args.name)
    args.log_path = None
    ...
    if is_master(args) and args.remote_sync is not None:
        ...
        result = remote_sync(
            os.path.join(args.logsdir, args.name),
    ...
    if is_master(args):
        ...
        logging.info("Params:")
        params_file = os.path.join(args.logsdir, args.name, "params.txt")
    ...
    args.save_logs = args.logsdir and args.logsdir.lower() != "none" and is_master(args)
    writer = None
...
def copy_codebase(args):
    ...
    new_code_path = os.path.join(args.logsdir, args.name, "code")
